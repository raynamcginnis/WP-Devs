...
/* Run this function before any other function*/
...
load_theme_textdomain($textdomain, get_template_directory() . '/languages/');
    ...
    add_theme_support( 'editors-styles' );
...
function wpdevs_register_block_styles() {
    wp_register_style( ' wpdevs_block-styles', get_template_directory_uri() . '/block-style.css' );
